...
sap.ui.define([
	"whr/com/br/ZLAREspelhoPontoEmpre/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"whr/com/br/ZLAREspelhoPontoEmpre/model/formatter",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator"
], function (BaseController, JSONModel, formatter, Filter, FilterOperator) {
	"use strict";

	return BaseController.extend("whr.com.br.ZLAREspelhoPontoEmpre.controller.Worklist", {
		...
		onSearch: function (oEvent) {
			if (oEvent.getParameters().refreshButtonPressed) {
				...
				if (sQuery && sQuery.length > 0) {
					aTableSearchState = [new Filter("Cname", FilterOperator.Contains, sQuery)];
				}
		...
		onPesquisar: function (oEvent) {
			...
			aFilters.push(new Filter("Langu", FilterOperator.EQ, 'P'));
